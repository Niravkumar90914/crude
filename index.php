	...
	$(document).ready(function() {
		$("#student-list").dataTable({
			...
			ajax: {
				...
				"dataSrc": function(json) {
					...
					for (var i = 0, ien = json.length; i < ien; i++) {
						...
						json[i].student_image_name = '<img width="100%" height="80px" src="assets/img/' + json[i].student_image_name + '">';
					}
					return json;
			...
			columns: [
				...
				{
					data: "student_name", "width":"150px"
				},
				{
					data: "student_image_name","width":"100px"
				},
				{
					data: "gender", "width":"30px"
				},
				{
					data: "date_of_birth", "width":"70px"					
				},
				{
					data: "email_address",
				},
				...
				{
					data: "student_hobbies", width:"80px"
				},
				{
