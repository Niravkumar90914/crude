...
<body class="bg-dark">
	...
	<script type="text/javascript">
		$(document).ready(function() {
					...
					submitHandler: function(form) {
						...
						$.ajax({
							...
							success: function(data) {
								...
								/*BEFORE CONVERT DATA TO JSON FIRST CHECK IS JSON OR NOT
								 IN PHP CODE SYNTEX ERROR, DATABASE CONNECTION ERROR ETC.
								 THEN ERROR COME WITH DATA. IN ELSE PART WE CAN SEE ERROR IN CONSOLE.
								 WE HAVE CREATE isJson() function to check.
								 */
								if (isJson(data)) {
									...
									console.log(data); //display bad data, syntex error, datadase etc. 
								}
							},
			...
			//THIS FUNCTION CHECK DATA IS IN JSON OR NOT
			function isJson(str) {
				try {
					JSON.parse(str);
				} catch (e) {
